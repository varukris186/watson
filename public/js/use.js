...
function setupUse(params) {
  ...
  document.getElementById("snap").addEventListener("click", function () {
    ...
    //var imgFile = new Base64Decode(img);
    classifyImage('', img, null,null,null);
  });
  ...
  function showResult(results) {
    ...
    sendToServerResults = results || null;
   ...
   * submit event
   */
  function classifyImage(imgPath, imageData, beforeFunction, afterFunction,customImg) {
    if (!lock('classify')) {
      return;
    }
